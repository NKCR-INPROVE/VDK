...
import static cz.incad.vdkcommon.xml.VDKNamespaces.*;
 ...
 * @author pavels
 */
public class VDKNamespaceContext implements NamespaceContext {
    ...
    static {
        ...
        MAP_PREFIX2URI.put("marc", MARC_NAMESPACE_URI);
